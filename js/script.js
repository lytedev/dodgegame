...
sweg.draw = function(dt) { // dt = delta time in seconds
	...
	if (cscreen == "game") {
		...
		sweg.ctx.fillStyle = "#fff8";
		sweg.ctx.strokeStyle = "#0000";
		sweg.graphics.drawStringWithOutline("M for Slo-Mo", 10, 34, 3);
		...
		sweg.graphics.drawStringWithOutline("Created at https://lyte.dev", sweg.width / 2, y + 75, 3);
		...
		sweg.graphics.drawStringWithOutline("Green and gold stationary boxes give bonus points", sweg.width / 2, y + 90, 3);
		sweg.graphics.drawStringWithOutline("Press L to start!", sweg.width / 2, y + 120, 3);
		sweg.graphics.drawStringWithOutline("Created at https://lyte.dev", sweg.width / 2, y + 150, 3);
	}
